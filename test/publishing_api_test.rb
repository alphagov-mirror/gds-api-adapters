...
describe GdsApi::PublishingApi do
  ...
  describe "#get_live_content" do
    describe "when the latest version of the content item is live" do
      before do
        publishing_api
    ...
    describe "when an older version of the content item is live" do
      before do
        publishing_api
    ...
    describe "when the content item has been unpublished" do
      before do
        publishing_api
